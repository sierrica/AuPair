package com.sierrica.model.config;
...
/**
 * {@code PGEnumUserType} converts a Java Enum to Postgres Enum type and viceversa.
 * <p/>
 *
 * @since 3/8/17
 */
@SuppressWarnings({ "unchecked", "rawtypes" })
public class PostgreEnumUserType implements EnhancedUserType, ParameterizedType {
